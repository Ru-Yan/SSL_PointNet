...
parser.add_argument('--lr_decay_steps', default='800, 1200,1600, 2000',
...
parser.add_argument('--cls_number', type=int, default=5, help='Please Set classification number')
...
if FLAGS.dataset == 'sunrgbd':
    ...
    from sunrgbd.bone_ssl_dataset import BoneLabeledDataset,BoneTestDataset
